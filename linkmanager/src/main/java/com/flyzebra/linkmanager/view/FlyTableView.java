package com.flyzebra.linkmanager.view;
...
import com.flyzebra.utils.RtlTools;

import java.util.List;

public class FlyTableView extends FrameLayout implements View.OnClickListener {
    ...
    public FlyTableView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlyTableView(Context context, AttributeSet attrs, int defStyleAttr) {
